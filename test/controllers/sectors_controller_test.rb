...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { alias: @sector.alias, describe: @sector.describe, floor: @sector.floor, name: @sector.name } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { alias: @sector.alias, describe: @sector.describe, floor: @sector.floor, name: @sector.name } }
